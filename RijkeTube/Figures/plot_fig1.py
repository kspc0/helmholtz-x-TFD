...
ax1.set_ylabel('Real Part of Discrete Derivatives')
ax1.set_title('Comparison of Derivatives over Perturbation')
...
ax2.set_ylabel('Imaginary Part of Discrete Derivatives')
ax2.set_title('Comparison of Derivatives over Perturbation')
